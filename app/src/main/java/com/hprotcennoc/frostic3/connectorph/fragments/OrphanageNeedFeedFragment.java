...
import com.hprotcennoc.frostic3.connectorph.AddNeed;
...
public class OrphanageNeedFeedFragment extends ListFragment {
    ...
    private static String url_feed_needs = "http://connectorph.byethost11.com/connectorph_php/feed_needs.php";
    ...
    public OrphanageNeedFeedFragment(){}
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_orphanage_need_feed, container, false);
        ...
        addNewNeed = (Button) rootView.findViewById(R.id.feed_buttonbar);
        addNewNeed.setOnClickListener(new View.OnClickListener() {
