...
public class AddDonation extends ActionBarActivity implements AdapterView.OnItemSelectedListener{
    ...
    private static String url_new_donation = "http://connectorph.byethost11.com/connectorph_php/add_donation.php";
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    AddDonation.this.setResult(Activity.RESULT_OK, data);
                    finish();
                } else {
