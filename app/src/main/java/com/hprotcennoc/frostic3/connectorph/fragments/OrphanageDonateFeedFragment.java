...
public class OrphanageDonateFeedFragment extends ListFragment {
    ...
    private static String url_feed_donation = "http://connectorph.byethost24.com/connectorph_php/feed_donation.php";
    private static String url_claim_donation = "http://connectorph.byethost24.com/connectorph_php/claim_donation.php";
