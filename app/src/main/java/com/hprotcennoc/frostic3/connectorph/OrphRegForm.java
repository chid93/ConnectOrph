...
public class OrphRegForm extends ActionBarActivity implements AdapterView.OnItemSelectedListener{
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.form_reg_orph);

        Spinner stateSpinner = (Spinner) findViewById(R.id.fr_orph_state_spinner);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        Spinner citySpinner = (Spinner) findViewById(R.id.fr_orph_city_spinner);
